...
export type Rectangle38IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Rectangle38Icon(props: Rectangle38IconProps) {
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur stdDeviation={"7.609"}></feGaussianBlur>
          ...
          <feBlend
            in2={"shape"}
            result={"effect1_innerShadow_110_1868"}
          ></feBlend>
        </filter>
      </defs>
    </svg>
...
export default Rectangle38Icon;
/* prettier-ignore-end */
